...
var hashPassword = function (plainPassword, salt) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, bcrypt_1.default.hash(plainPassword, salt)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
...
var verifyPassword = function (plainPassword, hashedPassword) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
...
var generateSign = function (payload) {
    return jsonwebtoken_1.default.sign(payload, config_1.AppSecret, { expiresIn: '7d' });
};
exports.generateSign = generateSign;
var validateSign = function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var token, payload;
    return __generator(this, function (_a) {
        token = req.get('Authorization');
        if (token) {
            try {
                payload = jsonwebtoken_1.default.verify(token.split(' ')[1], config_1.AppSecret);
                req.User = payload;
