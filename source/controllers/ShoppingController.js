            ...
            case 1:
                ...
                if (result.length > 0) {
                    ...
                    result.map(function (vandor) {
                        var food = vandor.foods;
                        foodResult_1.push.apply(foodResult_1, food.filter(function (food) { return food.readyTime <= 30; }));
                    });
                    res.status(200).json(foodResult_1);
                }
                else {
                    res.status(400).json({ message: "No Data Available" });
                }
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (result.length > 0) {
                    ...
                    result.map(function (vandor) {
                        var food = vandor.foods;
                        foodResult_2.push.apply(foodResult_2, food);
                    });
                    res.status(200).json(foodResult_2);
                }
                else {
                    res.status(400).json({ message: "No Data Available" });
                }
...
var RestuarantsByID = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, models_1.Vendor.findOne({ _id: id })
                        .populate("foods")];
            case 1:
                result = _a.sent();
                if (result) {
